export const data = {
  header: {
    ...
    headerDescription: [
      ...
      { title: "Fiable", description: "A l'écoute du business" },
  ...
  services: {
    ...
    description: "Je m’adapte aux exigences spécifiques de chaque projet.<br/> Et voici parmi mes compétences clés.",
    cards: [
      {
        title: "Integration",
    ...
    enterprise: [
      {
        ...
        Champions League...<br /> Développement du nouveau parcours utilisateurs de la partie Transactional Video On
        Demand de la plateforme myCANAL et de la marque blanche TelecomItalia TIM afin de permettre une mise en
        avant business.<br />Travail en coopération avec le studio design CANAL+ sur figma pour la création et
        intégration du Design System de CANAL+.<br /> Conception en étroite collaboration (Code review, peer prog,
      ...
      },
      {
        ...
        d’une zone cartographique.<br /> Développement d’une solution avec COTS technique, de problématique
        ...
        tests sur tout le projet).<br /> Contribution à la fiabilité et la maintenance du code (Code review) et
        documentation des spécifications technico-fonctionnels.<br /> Travail en méthodologie SCRUM agile sous Jira
      ...
      },
      {
        ...
        Propriétaires d’Armes.<br /> Gestion de la Tierce Maintenance Applicative en agilité permettant le
        décommissionnement et derniers lots d’évolutions MEP (Java, Oracle, mRemoteNG) du gestionnaire de
        propriétaires d’armes.<br /> Réalisation des features de l’application web des dépôt d’armes afin d'améliorer
        la gestion opérateur et mise en place d'accès aux données sécurisées (React, Redux, Symfony 3).
        <br />Documentation des spécifications fonctionnelles détaillées pour le PO et automatisation des tests à
        travers HPQC`,
      ...
      },
      {
        ...
        physiques/morales).<br /> Participation aux ateliers techniques avec les architectes internes et prestataires
